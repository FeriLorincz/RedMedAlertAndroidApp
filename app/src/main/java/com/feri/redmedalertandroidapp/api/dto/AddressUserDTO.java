...
public class AddressUserDTO {
    ...
    public String getVillageUser() {
        return villageUser;
    }

    public void setVillageUser(String villageUser) {
        this.villageUser = villageUser;
    }
    ...
    public String getStaircaseUser() {
        return staircaseUser;
    }

    public void setStaircaseUser(String staircaseUser) {
        this.staircaseUser = staircaseUser;
    }
    ...
    public void setFloorUser(String floorUser) {
        this.floorUser = floorUser;
    }

    public String getApartmentUser() {
        return apartmentUser;
    }

    public void setApartmentUser(String apartmentUser) {
    ...
    public void setCountyUser(String countyUser) {
    ...
    public String getNearestAmbulanceCityUser() {
        return nearestAmbulanceCityUser;
    }

    public void setNearestAmbulanceCityUser(String nearestAmbulanceCityUser) {
        this.nearestAmbulanceCityUser = nearestAmbulanceCityUser;
    }
}
